...
urlpatterns = [
    ...
    path('cancel/subscription/failed', CancelSubscriptionFailedView.as_view(), name='cancel_subscription_failed'),
    path('cancel/subscription/success', CancelSubscriptionSuccessView.as_view(), name='cancel_subscription_success'),
    ...
    path('checkout/<int:subscription_id>/', create_checkout_session, name='create_checkout_session'),
